			...
			<div class="col-md-12 column">
				...
				<form action="AddAction" method="get" class="form-horizontal"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="book.isbn" placeholder="${book.isbn }"
								required="required" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="book.author_id" placeholder="${book.author_id }"
								required="required" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="author.age"
								placeholder="${author.age }" required="required"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-5 control-label"><font
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="author.country"
								placeholder="${author.country }" required="required" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-5 control-label"><font
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="book.price"
								placeholder="${book.price }" required="required" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-5 control-label"><font
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="book.publisher"
								placeholder="${book.publisher }" required="required" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-5 control-label"><font
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="book.publish_date"
								placeholder="${book.publish_date }" placeholder="年-月-日" required="required" />
						</div>
					</div>
